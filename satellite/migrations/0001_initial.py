    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(
                        blank=True, null=True, upload_to="satellite/thumbnails/%Y/%m/"
                    ),
                ),
                (
                    "bounds",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["analysis", "-timestamp"],
                        name="satellite_a_analysi_7303dd_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["-upload_date", "status"], name="satellite_s_upload__acb980_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="satelliteimage",
            index=models.Index(
                fields=["analyzed", "-upload_date"],
                name="satellite_s_analyze_10e545_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="analysisresult",
            index=models.Index(
                fields=["-created_at", "status"], name="satellite_a_created_779d89_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="analysisresult",
            index=models.Index(
                fields=["satellite_image", "-created_at"],
                name="satellite_a_satelli_3d0041_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="satellite_t_detecte_a1be67_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="threatdetection",
            index=models.Index(
                ...
                name="satellite_t_threat__6fe36d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="threatdetection",
            index=models.Index(
                fields=["verified", "-detected_at"],
                name="satellite_t_verifie_57c84a_idx",
            ),
        ),
    ]
