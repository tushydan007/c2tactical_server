...
class SatelliteImageDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = [
            'id', 'upload_date', 'updated_date', 'uploaded_by',
            'optimized_image', 'thumbnail', 'bounds', 'center_point',
            'width', 'height', 'bands', 'file_size', 'status',
            'processing_error', 'analyzed', 'analysis_count'
        ]
...
class ThreatDetectionSerializer(GeoFeatureModelSerializer):
    ...
    class Meta:
        ...
        geo_field = 'location'
        fields = [
            'id', 'analysis', 'satellite_image', 'image_name',
            'threat_type', 'threat_type_display', 'severity', 'severity_display',
            'location_coords', 'confidence', 'description',
            'detected_at', 'verified', 'acknowledged', 'notes'
        ]
        read_only_fields = [
            'id', 'analysis', 'satellite_image', 'detected_at'
        ]
...
class AnalysisResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'satellite_image', 'image_name', 'analysis_type',
