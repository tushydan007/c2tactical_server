...
class SatelliteImage(models.Model):
    ...
    original_image = models.FileField(
        ...
        validators=[FileExtensionValidator(allowed_extensions=['tif', 'tiff', 'geotiff'])],
    ...
    acquisition_date = models.DateTimeField(
        null=True,
        blank=True,
        help_text='Date when the satellite captured this image'
    )
...
class AnalysisResult(models.Model):
    ...
    raw_data = models.JSONField(
        default=dict,
        help_text='Detailed analysis data in JSON format'
    )
...
class ThreatDetection(models.Model):
    ...
    technical_details = models.JSONField(
        default=dict,
        help_text='Technical analysis details'
    )
